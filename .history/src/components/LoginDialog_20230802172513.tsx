    ...
    <Dialog>
      ...
      <DialogContent>
        ...
        <form className='mt-16 flex flex-col justify-start w-full gap-6'>
          ...
          {signIn 
          ? <button onClick={handleGoogleLogin} className='mt-3 uppercase max-w-fit mx-auto font-sans text-white rounded-lg px-6 py-3 bg-[#5F4B43] hover:bg-[#422f28]'>Enter</button>
          : <button onClick={handleGoogleLogin} className='mt-3 uppercase max-w-fit mx-auto font-sans text-white rounded-lg px-6 py-3 bg-[#5F4B43] hover:bg-[#422f28]'>Create account</button>
          }
        </form>

  ...
  return (
    <div>
      ...
      <div className="flex flex-col justify-start gap-8 mb-20">
        ...
        {props.isFiltered && <button onClick={props.onClickCancel} className="bg-red-700 py-2 px-4 md:py-3 md:px-6 max-w-fit rounded-md text-white font-sans">Cancel filter</button>}
      </div>
    </div>
  )
}

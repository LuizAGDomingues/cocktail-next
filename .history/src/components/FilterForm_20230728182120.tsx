          ...
          <SelectContent className='font-sans'>
            <SelectGroup>
              ...
              alcoholicData.map((alcoholic: any) => {
                return (
                  <SelectItem key={alcoholic.strCategory} value={alcoholic.strCategory}>{alcoholic.strCategory}</SelectItem>
                )
              })}
            </SelectGroup>
          </SelectContent>
        ...
        <Select>
          ...
          <SelectContent className='font-sans'>
            <SelectGroup>
              ...
              {!glassData ? <SelectItem value="">Failed to load glasss</SelectItem> :
              glassData.map((glass: any) => {
                return (
                  <SelectItem key={glass.strCategory} value={glass.strCategory}>{glass.strCategory}</SelectItem>
                )
              })}
            </SelectGroup>
          </SelectContent>

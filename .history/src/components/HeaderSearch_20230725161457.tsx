...
function HeaderSearch() {
  return (
    <header className='flex items-center justify-between'>
      ...
      <button className='inline-flex px-6 py-3 items-center justify-center rounded-lg text-white font-sans text-base bg-[#675045] hover:bg-[#675045] transit'>LOGIN</button>
    </header>
  )
}

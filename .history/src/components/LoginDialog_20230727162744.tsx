    ...
    <Dialog>
      ...
      <DialogContent>
        ...
        <div className='inline-flex p-1 justify-center items-center bg-[#A3A1A1] rounded-lg font-sans'>
          <button onClick={defineSignIn} className='flex items-center justify-center py-3 px-14 rounded-lg bg-white'>SignIn</button>
          <button onClick={defineSignUp} className='flex items-center justify-center py-3 px-14 rounded-lg'>SignUp</button>
        </div>
      </DialogContent>
    </Dialog>
  )

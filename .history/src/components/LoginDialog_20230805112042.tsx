    ...
    <Dialog>
      ...
      <DialogContent>
        ...
        <form onSubmit={handleLogin_Create} className='mt-16 flex flex-col justify-start w-full gap-6'>
          ...
          {signIn 
          ? <button type='submit' className='mt-3 uppercase w-40 md:max-w-fit mx-auto font-sans text-white rounded-lg px-6 py-3 bg-[#5F4B43] hover:bg-[#422f28]'>Enter</button>
          : <button type='submit' className='mt-3 uppercase w-40 md:max-w-fit mx-auto font-sans text-white rounded-lg px-6 py-3 bg-[#5F4B43] hover:bg-[#422f28]'>Create account</button>
          }

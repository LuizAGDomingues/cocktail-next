  ...
  return (
    <Dialog>
      ...
      <DialogContent>
        ...
        <form className='mt-16 flex flex-col justify-start w-full'>
          <div>
          ...
          <div>
            ...
            <input type="password" name="password" id="password" className='max-w-fit py-2 px-1 flex items-center rounded-lg bg-[#E4E4E4] text-black placeholder:text-[#646464]' placeholder='********' />
          </div>

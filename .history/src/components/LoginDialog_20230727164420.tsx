    ...
    <Dialog>
      ...
      <DialogContent>
        ...
        <form className='mt-16 flex flex-col justify-start w-full gap-6'>
          ...
          <button className='uppercase max-w-fit w-full flex items-center justify-center font-sans text-white rounded-md px-6 py-3 bg-[#5F4B43] hover:bg-[#422f28]'>Enter</button>
        </form>
      </DialogContent>
    </Dialog>
  )

        ...
        <form onSubmit={handleLogin_Create} className='mt-16 flex flex-col justify-start w-full gap-6'>
          ...
          {!signIn &&
            <div>
              ...
              {passwordError && <span className="text-red-600 text-sm mt-1">The passwords must be equal</span>}
            </div>
          }
          {signIn 
          ...
          {loginError && <span className="text-red-600 text-sm mt-1">An error happened. Please, check your informations.</span>}
        </form>

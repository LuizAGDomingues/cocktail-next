    ...
    <Dialog>
      ...
      <DialogContent>
        ...
        <div className='flex items-center justify-center gap-2'>
          <div className='flex-shrink-0 h-[1px] w-36 bg-gradient-to-r from-[#1F1007] to-[#C2C2C2]'></div>
          <span className='text-[#C2C2C2] font-sans text-xs'>Or Connect With</span>
          <div className='flex-shrink-0 h-[1px] w-36 bg-gradient-to-r from-[#C2C2C2] to-[#1F1007]'></div>
        </div>

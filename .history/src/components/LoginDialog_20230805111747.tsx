  ...
  return (
    <Dialog>
      ...
      <DialogContent>
        ...
        <div className='p-1 justify-center items-center bg-[#A3A1A1] rounded-lg font-sans'>
          <button onClick={defineSignIn} className={`flex w-full items-center justify-center py-3 px-5 md:px-14 rounded-lg transition-colors duration-200 ${signIn && 'bg-white'}`}>SignIn</button>
          <button onClick={defineSignUp} className={`flex w-full items-center justify-center py-3 px-5 md:px-14 rounded-lg transition-colors duration-200 ${!signIn && 'bg-white'}`}>SignUp</button>
        </div>

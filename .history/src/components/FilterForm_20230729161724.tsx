  ...
  return (
    <div>
      ...
      <div className='mt-6 text-white font-sans'>
        ...
        <Select>
          ...
          <SelectContent className='font-sans'>
            <SelectGroup ={e => handleSelectCategoryChange(e)}>
      ...
      <div className='mt-6 text-white font-sans'>
        ...
        <Select>
          <SelectTrigger className="w-60">
            <SelectValue placeholder="Alcoholic" ={handleSelectAlcoholicChange} />
          </SelectTrigger>
          <SelectContent className='font-sans'>
            <SelectGroup>
      ...
      <div className='mt-6 text-white font-sans'>
        ...
        <Select>
          <SelectTrigger className="w-60">
            <SelectValue placeholder="Martini Glass" ={handleSelectGlassChange} />
          </SelectTrigger>
          <SelectContent className='font-sans'>
            <SelectGroup>

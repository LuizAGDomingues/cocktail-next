      ...
      <DialogContent>
        ...
        <form onSubmit={handleLogin_Create} className='mt-16 flex flex-col justify-start w-full gap-6'>
          <div>
            ...
            <input type="text" name="email" id="email" onChange={() => setEmail()} className='w-full py-2 px-2 flex items-center rounded-lg font-sans bg-[#E4E4E4] text-black placeholder:text-[#646464]' placeholder='example@email.com' />
          </div>
          <div>

...
function LoginDialog({onUserLoged}: LoginDialogProps) {
  ...
  return (
    <Dialog>
      <DialogTrigger>
        <button className='inline-flex px md:px-6 md:py-3 items-center justify-center rounded-lg text-white font-sans text-base bg-[#675045] hover:bg-[#443027] transition-colors duration-200'>LOGIN</button>
      </DialogTrigger>
      <DialogContent>
        <DialogHeader>
          <DialogTitle>

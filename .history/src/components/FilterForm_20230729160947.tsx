  ...
  return (
    <div>
      ...
      <div className='mt-6 text-white font-sans'>
        ...
        <Select>
          <SelectTrigger className="w-60">
            <SelectValue placeholder="Cocktail"  onChange={handleSelectCategoryChange}/>
          </SelectTrigger>
      ...
      <div className='mt-6 text-white font-sans'>
        ...
        <Select>
          <SelectTrigger className="w-60">
            <SelectValue placeholder="Alcoholic" onChange={} />
          </SelectTrigger>
          <SelectContent className='font-sans'>
            <SelectGroup>
      ...
      <div className='mt-6 text-white font-sans'>
        ...
        <Select>
          <SelectTrigger className="w-60">
            <SelectValue placeholder="Martini Gl onChange={}ass" />
          </SelectTrigger>
          <SelectContent className='font-sans'>
            <SelectGroup>

  ...
  return (
    <Dialog>
      ...
      <DialogContent>
        ...
        <form className='mt-16 flex flex-col justify-start w-full gap-'>
          <div>
            <label htmlFor="email" className='text-white text-center font-sans'>Email</label>
            <input type="text" name="email" id="email" className='w-full py-2 px-1 flex items-center rounded-lg bg-[#E4E4E4] text-black placeholder:text-[#646464]' placeholder='example@email.com' />
          </div>
          <div>
            <label htmlFor="password" className='text-white text-center font-sans'>Password</label>
            <input type="password" name="password" id="password" className='w-full py-2 px-1 flex items-center rounded-lg bg-[#E4E4E4] text-black placeholder:text-[#646464]' placeholder='********' />
          </div>

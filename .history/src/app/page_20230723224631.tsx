  ...
  return (
    <div className="h-screen w-full bg-[url('../assets/test1.png')] bg-cover bg-no-repeat">
      ...
      <div className="flex items-center">
        <button className="max-w-fit rounded-full mt-16 py-4 px-12 text-white text-center text-xl bg-gradient-to-r from-[#5F4B43] via-[#675045] to-[#705548] hover: uppercase relative mx-auto">Explore Now</button>
      </div>
    </div>
  )
}

export default function Home() {
  return (
    <div className="h-screen w-full bg-[url('../assets/test1.png')] bg-cover bg-no-repeat">
      ...
      <button className="w-ful max-w-fit rounded-full mx-auto mt-16 py-4 px-12 text-white text-center text-xl bg-gradient-to-r from-[#5F4B43] via-[#675045] to-[#705548] uppercase relative">Explore Now</button>
    </div>
  )
}

  ...
  return (
    <div className="h-screen w-full bg-[url('../assets/test1.png')] bg-cover bg-no-repeat">
      ...
      <div className="flex items-center">
        <Link href='/initial' className="max-w-fit rounded-full mt-16 py-4 px-12 text-white text-center text-xl bg-[#5F4B43] hover:bg-[#422f28] transition duration-500 ease-in-out uppercase relative mx-auto">Explore Now</Link>
      </div>
    </div>
  )
}

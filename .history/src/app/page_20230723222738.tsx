export default function Home() {
  return (
    <div className="h-screen w-full bg-[url('../assets/test1.png')] bg-cover bg-no-repeat">
      ...
      <div className="text-white text-center relative py-[30rem] uppercase">
        <h1 className="text-7xl">MIXOLOGYMATE</h1>
        <span className="text-2xl py-5">Your perfect partner to explore the world of <br/>drinks!</span>
      </div>
    </div>
  )
}

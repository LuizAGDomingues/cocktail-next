      ...
      <div className="mt-44 text-white">
        <div className="flex items-center justify-center gap-6">
          ...
          <div>
            ...
            <ul>
              <li>{drinkData.strMeasure1}+{}</li>
              <li>{drinkData.strMeasure2}</li>
              <li>{drinkData.strMeasure3}</li>
              <li>{drinkData.strMeasure4}</li>
              <li>{drinkData.strMeasure5}</li>
              <li>{drinkData.strMeasure6}</li>
              <li>{drinkData.strMeasure7}</li>
              <li>{drinkData.strMeasure8}</li>
              <li>{drinkData.strMeasure9}</li>
              <li>{drinkData.strMeasure10}</li>
              <li>{drinkData.strMeasure11}</li>
              <li>{drinkData.strMeasure12}</li>
              <li>{drinkData.strMeasure13}</li>
              <li>{drinkData.strMeasure14}</li>
              <li>{drinkData.strMeasure15}</li>
            </ul>

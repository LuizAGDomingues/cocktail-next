...
export default function Drink({ params }: { params: { drinkId: string } }) {
  ...
  const handleFavorite = () => {
    ...
    const favoriteDrinkData: {strDrinkThumb: string, strDrink: string, drinkId: string} = { strDrink: drinkData!.strDrink, strDrinkThumb: drinkData!.strDrinkThumb, drinkData!.idDrink}

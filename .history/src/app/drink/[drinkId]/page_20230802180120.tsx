...
export default function Drink({ params }: { params: { drinkId: string } }) {
  ...
  const handleFavorite = () => {
    ...
    const favoriteDrinkData: {strDrinkThumb: string, strDrink: string} = { strDrink: drinkData!.strDrink, strDrinkThumb: drinkData!.strDrinkThumb}
    const favoriteDrinkDataJSON = favoriteDrinkData
    if(!hasFavorite){
      'use server';
		  cookies().set('favorites', 'junior');
    } else {

      ...
      <div className="mt-44 text-white">
        <div className="flex items-center justify-center gap-6">
          ...
          <div>
            ...
            <ul>
              <li>{drinkData.strMeasure1} + {drinkData}</li>
              <li>{drinkData.strMeasure2} + {drinkData}</li>
              <li>{drinkData.strMeasure3} + {drinkData}</li>
              <li>{drinkData.strMeasure4} + {drinkData}</li>
              <li>{drinkData.strMeasure5} + {drinkData}</li>
              <li>{drinkData.strMeasure6} + {drinkData}</li>
              <li>{drinkData.strMeasure7} + {drinkData}</li>
              <li>{drinkData.strMeasure8} + {drinkData}</li>
              <li>{drinkData.strMeasure9} + {drinkData}</li>
              <li>{drinkData.strMeasure10} + {drinkData}</li>
              <li>{drinkData.strMeasure11} + {drinkData}</li>
              <li>{drinkData.strMeasure12} + {drinkData}</li>
              <li>{drinkData.strMeasure13} + {drinkData}</li>
              <li>{drinkData.strMeasure14} + {drinkData}</li>
              <li>{drinkData.strMeasure15} + {drinkData}</li>
            </ul>

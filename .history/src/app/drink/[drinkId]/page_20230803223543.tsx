...
export default function Drink({ params }: { params: { drinkId: string } }) {
  ...
  return (
    <main className="w-full h-screen px-8 py-6 bg-gradient-to-r from-[#251A14] to-[#120D0A] overflow-auto">
      {loading ? <span className="text-2xl text-gray-500 underline ml-5">Loading...</span> : 
        drinkData === null ? <span className="text-2xl text-red-700 underline ml-28">Sorry 😔, an error occurred in the catalog. Try again with another drink or inform us.</span> : 
        <></>
      }

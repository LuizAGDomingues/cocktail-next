        ...
        <div className="flex items-center justify-center gap-6">
          ...
          <div>
            ...
            <ul>
              ...
              <li>{drinkData.strMeasure2} + {drinkData.strIngredient1}</li>
              <li>{drinkData.strMeasure3} + {drinkData.strIngredient1}</li>
              <li>{drinkData.strMeasure4} + {drinkData.strIngredient1}</li>
              <li>{drinkData.strMeasure5} + {drinkData.strIngredient1}</li>
              <li>{drinkData.strMeasure6} + {drinkData.strIngredient1}</li>
              <li>{drinkData.strMeasure7} + {drinkData.strIngredient1}</li>
              <li>{drinkData.strMeasure8} + {drinkData.strIngredient1}</li>
              <li>{drinkData.strMeasure9} + {drinkData.strIngredient1}</li>
              <li>{drinkData.strMeasure10} + {drinkData.strIngredient1}</li>
              <li>{drinkData.strMeasure11} + {drinkData.strIngredient1}</li>
              <li>{drinkData.strMeasure12} + {drinkData.strIngredient1}</li>
              <li>{drinkData.strMeasure13} + {drinkData.strIngredient1}</li>
              <li>{drinkData.strMeasure14} + {drinkData.strIngredient1}</li>
              <li>{drinkData.strMeasure15} + {drinkData.strIngredient1}</li>
            </ul>
            <h3 className="text-4xl underline">Instructions:</h3>
            <p className="mt-3 text-justify font-sans text-xl mr-24">{drinkData.strInstructions}</p>
          </div>
        </div>
        <span></span>
        <span></span>

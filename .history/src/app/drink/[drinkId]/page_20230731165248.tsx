    ...
    <main className="w-full h-screen px-8 py-6 bg-gradient-to-r from-[#251A14] to-[#120D0A] overflow-auto">
      ...
      <div className="mt-36 ml-44 text-white">
        <div className="flex items-center justify-center gap-6">
          <Image src={drinkData.strDrinkThumb} alt="Drink image" width={556} height={361} sizes="cover" className="flex-shrink-0 rounded-md" />
          <div>
            <h3 className="text-4xl underline">Ingredients:</h3>
            <ul className="font-sans text-xl mt-6">
            ...
            <h3 className="text-4xl underline mt-7">Instructions:</h3>

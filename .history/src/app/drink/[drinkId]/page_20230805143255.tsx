...
export default function Drink({ params }: { params: { drinkId: string } }) {
  ...
  return (
    <main className="w-full h-screen px-8 py-6 bg-gradient-to-r from-[#251A14] to-[#120D0A] overflow-auto">
      ...
      <div className="mt-36 md:ml-44 text-white">
        <div className="md:flex items-start justify-center gap-14">
          <div className="flex gap-4 md:flex-col md:gap-0">
            ...
            <div className="flex flex-col">
              <span className="text-xl md:mt-5">{drinkData.strGlass}</span>
              <span className="text-xl mt-5 md:mt-1">{drinkData.strCategory}</span>
              <span className="text-xl mt-5 md:mt-1">{drinkData.strAlcoholic}</span>
            </div>
          </div>
          <div className="mt-5 md:mt-0">
            <h3 className="text-2xl md:text-4xl underline">Ingredients:</h3>
            <ul className="font-sans text-lg md:text-xl mt-3">
            ...
            <h3 className="text-2xl md:text-4x underline mt-14">Instructions:</h3>
            <p className="mt-3 w-[35rem] text-justify font-sans text-lg md:text-xl mr-24">{drinkData.strInstructions}</p>
          </div>
        </div>
      </div>
    </main>

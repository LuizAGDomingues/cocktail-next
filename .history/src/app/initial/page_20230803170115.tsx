...
export default function Initial() {
  const [favoriteDataCokkie, setFavoriteDataCookies] = useState<{strDrinkThumb: string, strDrink: string, drinkId: string}[]>()
  ...
  return (
    <main className="w-full h-screen px-8 py-6 bg-gradient-to-r from-[#251A14] to-[#120D0A] overflow-auto">
      <HeaderSearch />
      <div className='mt-32'>
        <Favorites hasCookiesFavorites={hasCookiesFavorites} favoriteData={favoriteDataCokkie} />
      </div>

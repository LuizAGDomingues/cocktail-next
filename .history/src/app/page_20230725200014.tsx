  ...
  return (
    <div className="h-screen w-full bg-[url('../assets/test1.png')] bg-cover bg-no-repeat">
      ...
      <div className="flex items-center">
        <Link href='/initial' className="max-w-fit rounded-full mt-16 py-4 px-12 text-white text-center text-xl bg-blue-500 hover:bg-gradient-to-r from-blue-500 via-blue-600 to-indigo-500 transition-colors duration-300 uppercase relative mx-auto">Explore Now</Link>
      </div>
    </div>
  )
}

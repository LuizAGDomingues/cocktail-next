      ...
      <div className="flex">
        <form>
          ...
          <div className="gap-1 mt-6">
            ...
            <input type="text" name="category" id="category" className="font-sans rounded-lg bg-[#E4E4E4] flex items-center justify-between w-48 py-2 px-2 text-black placeholder:text-[#646464]" placeholder="Cocktail"  />
          </div>

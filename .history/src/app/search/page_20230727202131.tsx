      ...
      <div className="flex">
        <form>
          ...
          <div className="flex flex-col justify-start gap-1 mt-3">
            ...
            <input type="text" name="alcoholic" id="alcoholic" className="flex items-center justify-between w-48 py-2 px-2 text-black placeholder:text-[#646464]" placeholder="Cocktail"/>
          </div>
          <div className="flex flex-col justify-start gap-1 mt-3">

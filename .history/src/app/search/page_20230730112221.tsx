...
export default function Search() {
  ...
  const async handleFilter = (values: { selectCategory: string; selectAlcoholic: string; selectGlass: string }) => {
    setFilteredDrinkData([])
    if(values.selectCategory !== '') {
      if(filteredDrinkData.length === 0) {
        const drinksFilteredByCategory = drinkData.filter((drink: any) => drink.strCategory === values.selectCategory);
        setFilteredDrinkData(drinksFilteredByCategory)
      } else {
        const drinksFilteredByCategory = filteredDrinkData.filter((drink: any) => drink.strCategory === values.selectCategory);
        setFilteredDrinkData(drinksFilteredByCategory)
      }
    }
    if(values.selectAlcoholic !== '') {
      if(filteredDrinkData.length === 0) {
        const drinksFilteredByAlcoholic = drinkData.filter((drink: any) => drink.strAlcoholic === values.selectAlcoholic);
        setFilteredDrinkData(drinksFilteredByAlcoholic)
      } else {
        const drinksFilteredByAlcoholic = filteredDrinkData.filter((drink: any) => drink.strAlcoholic === values.selectAlcoholic);
        setFilteredDrinkData(drinksFilteredByAlcoholic)
      }
    }
    if(values.selectGlass !== '') {
      if(filteredDrinkData.length === 0) {
        const drinksFilteredByGlass = drinkData.filter((drink: any) => drink.strGlass === values.selectGlass);
        setFilteredDrinkData(drinksFilteredByGlass)
      } else {
        const drinksFilteredByGlass = filteredDrinkData.filter((drink: any) => drink.strGlass === values.selectGlass);
        setFilteredDrinkData(drinksFilteredByGlass)
      }
    }
  };

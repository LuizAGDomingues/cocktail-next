      ...
      <div className="flex">
        <form>
          ...
          <div className="flex flex-col justify-start gap-1 mt-6">
            ...
            <input type="text" name="category" id="category" className="rounded- flex items-center justify-between w-48 py-2 px-2 text-black placeholder:text-[#646464]" placeholder="Cocktail"  />
          </div>
          <div className="flex flex-col justify-start gap-1 mt-3">
            ...
            <input type="text" name="alcoholic" id="alcoholic" className="rounded- flex items-center justify-between w-48 py-2 px-2 text-black placeholder:text-[#646464]" placeholder="Alcoholic"/>
          </div>
          <div className="flex flex-col justify-start gap-1 mt-3">
            <label htmlFor="glass" className="text-white text-center font-sans text-sm">Category</label>
            <input type="text" name="glass" id="glass" className="rounded- flex items-center justify-between w-48 py-2 px-2 text-black placeholder:text-[#646464]" placeholder="Martini Glass"/>
          </div>
        </form>

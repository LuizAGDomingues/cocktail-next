      ...
      <div className="flex">
        ...
        {!drinkData ? <span>Loading...</span> :
          drinkData.map((drinkElement: any) => {
            return (
              <SearchDrinkCard imageURL={drinkElement.strDrinkThumb} name={drinkElement.strDrink} glass="" category={drinkElement.} alcoholic={drinkElement.} key={drinkElement.idDrink} id={drinkElement.idDrink} />
            )
          })
        }
      </div>

    ...
    <main className="w-full h-screen px-8 py-6 bg-gradient-to-r from-[#251A14] to-[#120D0A] overflow-auto">
      ...
      <div className="flex">
        ...
        <div className="grid grid-cols-4 gap-10 ml-28">
          {error ? <span className="text-2xl text-red-700 underline mr-5">Sorry 😔, an error occurred in the catalog. Try again with another drink or inform us.</span> :
            !paginateDrinkData ? <span className="text-2xl text-gray-500 underline mr-5">Loading...</span> : 
            !paginateDrinkData[0].idDrink ? <span className="text-2xl text-red-700 underline mr-5">Sorry 😔, we do not have this drink in the catalog</span> :

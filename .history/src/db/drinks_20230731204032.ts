export interface topDrinksP

export const drinks = [
  {
    "drinkId": "11007",
    "name": "Margarita",
    "description": "The Margarita is a refreshing and classic cocktail that combines tequila, orange liqueur, and lime juice, usually served in a glass with a salted rim.",
    "history": "The origin of the Margarita is uncertain, but it is believed to have been created in Mexico in the 1930s or 1940s. There are several stories about how the cocktail was invented, but one of the most popular involves a socialite named Margarita, who asked the bartender to create a drink for her with the ingredients available at the time.",
    "imageURL": "https:/www.thecocktaildb.com/images/media/drink/5noda61589575158.jpg"
  },
  {
    "drinkId": "11728",
    "name": "Martini",
    "description": "The Martini is an iconic and sophisticated cocktail made with gin and vermouth, usually garnished with an olive or a lemon twist.",
    "history": "The Martini has controversial origins and has evolved over the years. One of the most well-known stories is that the cocktail was created by a bartender in San Francisco during the California Gold Rush in the mid-19th century. Another theory suggests that the Martini evolved from an Italian cocktail called Martinez, made with similar ingredients.",
